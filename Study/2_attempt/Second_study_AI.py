...
def create_tests() -> None:
    ...
    file_quest.close()
    file_ans.close()
    print(f"\nFiles for train have been successfully recorded! Total inputs = {total_input}")
...
def main():
    ...
    network = NeuralNetwork(neuron_weights_input=3, count_h=5, count_output=1)
    ...
    while True:
        try:
            ...
            if len(user_input) == 3:
                ...
                print(f"Continuation: {ans_user=}; Gender -> 1 - F; 0 - M;\n")
            else:
